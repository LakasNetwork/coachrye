...
<div class="container">
    <div class="text-center mb-5">
        ...
        <p class="lead text-muted mx-auto" style="max-width: 700px;">
            Whether you are building a modern web application or a high-performance team, 
            every great solution begins with a strategic inquiry.
        </p>
    </div>
                ...
                <div class="row g-0">
                    <div class="col-md-4 bg-primary d-flex align-items-center justify-content-center p-4">
                        <div class="text-center text-white">
                            ...
                            <h3 class="h5 mt-3">Free Discovery</h3>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="card-body p-4">
                            <h2 class="h4 fw-bold">Strategic Discovery Session</h2>
                            <p class="text-muted">Identify your hurdles. Map your path. A 30-minute high-level diagnostic call to explore your technical challenges or leadership goals.</p>
