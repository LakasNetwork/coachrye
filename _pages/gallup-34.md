...
<link href="https://fonts.googleapis.com/css2?family=Crimson+Pro:wght@400;600;700&family=Outfit:wght@300;400;600&display=swap" rel="stylesheet">
...
<section class="hero text-center">
    <div class="container">
        <h1>The 34 CliftonStrengths<sup>®</sup> Talent Themes</h1>
        <p class="lead">Discover the naturally recurring patterns of thought, feeling, and behavior that make you exceptional</p>
    </div>
</section>
...
<div class="container content-section">    
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-lg-10">
            <div class="info-box">
                <h3>Your Unique Combination is Your Superpower</h3>
                <p>While there are 34 talent themes, your unique combination of themes creates over 33 million possible permutations. This means your Top 5 CliftonStrengths profile is virtually unique to you—like a fingerprint of your potential.</p>
                <p class="mb-0">Click any talent theme above to explore its details on the official Gallup CliftonStrengths website. Understanding each theme helps you recognize your natural patterns and develop them into consistent strengths.</p>
            </div>
        </div>
    </div>
</div>
